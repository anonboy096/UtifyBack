...
<html>
	<head>
		...
		<meta name="description" content="JioSaavn API by Umang Patel@github" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="${config.urls.siteUrl}" />
		<meta property="og:title" content="JioSaavn API" />
		<meta property="og:description" content="JioSaavn API by Umang Patel@github" />
		<meta property="twitter:card" content="summary_large_image" />
		<meta property="twitter:url" content="${config.urls.siteUrl}" />
		<meta property="twitter:title" content="JioSaavn API by Umang Patel@github" />
		<meta
			property="twitter:description"
			content="JioSaavn API by Umang Patel@github"
		/>
	...
	<style>
		...
		/* https://github.com/Umang Patel/react-template-vite/blob/master/src/styles/layout.css */
		.layout {
	...
	>
		...
		>
			...
			<a
				href="https://github.com/anonboy96"
				target="_blank"
				...
				>
					<div class="flex flex-col">
						...
						<p class="mt-2 text-neutral-400">
							Jiosaavn unofficial API is created by Umang Patel. Check out
